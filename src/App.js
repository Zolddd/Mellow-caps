...
function App() {
  const [products] = useState([
    { id: 1, name: "Classic Cap", price: 20, image: cap1, description: "A stylish classic cap for everyday wear." },
    { id: 2, name: "Sporty Cap", price: 25, image: cap2, description: "A sporty cap designed for outdoor activities." },
    { id: 3, name: "Luxury Cap", price: 30, image: cap3, description: "A premium cap with a luxury feel." }
  ]);
